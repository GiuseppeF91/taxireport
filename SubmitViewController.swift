...
class SubmitViewController: UIViewController , UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIGestureRecognizerDelegate,AVAudioRecorderDelegate,UIActionSheetDelegate,UITextViewDelegate{
    ...
    func textViewDidEndEditing(textView: UITextView) {
        if (textView.text == "") {
            textView.text = "Explain what happened here. Be as detailed as possible. This will be transcribed and added to the 311 complaint before it is submitted."
    ...
    func textViewDidBeginEditing(textView: UITextView){
        if (textView.text == "Explain what happened here. Be as detailed as possible. This will be transcribed and added to the 311 complaint before it is submitted."){
            textView.text = ""
    ...
    */
    ...
    @IBAction func clickpicture(sender: AnyObject) {
        ...
        actionSheet = UIActionSheet(title: "select media", delegate: self, cancelButtonTitle: "Cancel", destructiveButtonTitle: nil,otherButtonTitles:"Capture Video","Select Video from Gallery", "Capture Photo", "Select Photo from Gallery")
    ...
    func imagePickerController(picker: UIImagePickerController!, didFinishPickingMediaWithInfo info:NSDictionary!) {
        if (selectIndex == 0)
        {
            ...
            self.cameraicon.image = UIImage(named: "greencamera.png")
            photoData = nil
