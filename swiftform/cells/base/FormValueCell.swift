...
class FormValueCell: FormBaseCell {
    ...
    override func configure() {
        ...
        var leftMarginConstraint:NSLayoutConstraint = NSLayoutConstraint(item: self.valueLabel, attribute: NSLayoutAttribute.Left, relatedBy: NSLayoutRelation.Equal, toItem: self.contentView, attribute: NSLayoutAttribute.Left, multiplier: 1, constant: 120)
